...
exports.MeasurementModule = MeasurementModule = __decorate([
    (0, common_1.Module)({
        imports: [mongoose_1.MongooseModule.forFeature([{ name: measurement_schema_1.Measurement.name, schema: measurement_schema_1.MeasurementSchema }])],
